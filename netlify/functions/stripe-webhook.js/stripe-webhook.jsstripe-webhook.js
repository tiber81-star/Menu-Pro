...
exports.handler = async (event) => {
    ...
    if (stripeEvent.type === 'checkout.session.completed') {
        ...
        // Envoi de l'email (MODE TEST : utilisez onboarding@resend.dev)
        try {
            await resend.emails.send({
                ...
                html: `<p>Merci pour votre achat !</p>
                       ...
                       <p>Cliquez ici pour télécharger le logiciel : <a href="https://menupro2.netlify.app/MenuPro.html">Télécharger MenuPro</a></p>
